...
{
    const string BROKER_NAME = "game_net_event_bus";
    ...
    public EventBusRabbitMQ(IRabbitMQPersistentConnection persistentConnection, ILogger<EventBusRabbitMQ> logger,
        IServiceProvider serviceProvider, IEventBusSubscriptionManager subsManager, string queueName = null, int retryCount = 5)
    {
        ...
        where TH : IIntegrationEventHandler<T>
    {
        ...
        _subsManager.DeleteSubscription<T, TH>();
    }

    public void UnsubscribeDynamic<TH>(string eventName)
        where TH : IDynamicIntegrationEventHandler
    {
        _subsManager.DeleteDynamicSubscription<TH>(eventName);
    }
